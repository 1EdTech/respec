...
const usageSections = [
  {
    header: "respec2drupal",
    content:
      "Converts a ReSpec source file to Drupal HTML and prints to std out.",
  },
  {
    header: "Options",
    optionList,
  ...
  {
    content: "Project home: {underline https://github.com/IMSGlobal/respec}",
    raw: true,
  },
];
